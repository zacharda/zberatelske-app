...
function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen relative">
      ...
      {/* MAIN CONTENT */}
      <main className="flex-1 bg-white flex flex-col transition-all duration-300 ease-in-out mt-16 md:mt-16">
        {/* PAGE CONTENT */}
        <div className="flex-1 pt-6">
          <h2 className="text-2xl font-bold mb-4 pl-6">Coin Collection</h2>
